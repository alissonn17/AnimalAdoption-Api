...
db.models.Voluntario = require('./Voluntario')(sequelize, Sequelize.DataTypes);
db.models.Abrigo = require('./Abrigo')(sequelize, Sequelize.DataTypes);
db.models.Adocao = require('./Adocao')(sequelize, Sequelize.DataTypes);
